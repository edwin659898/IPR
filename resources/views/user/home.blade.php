        ...
        <div class="dt-responsive table-responsive">
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <tr>
              ...
              <td>{{ $t->status }}</td>
              <td><a href="{{route('user.show',$t->id)}}"><i class="fas fa-eye text-green-800"></i></a></td>
              <td><a href="{{route('user.destroy',$t->id)}}"><i class="fas fa-trash text-red-500 hover:text-red-800"></i></a></td>
