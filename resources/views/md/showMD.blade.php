...
<div class="col-sm-12">
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{route('md.updateMD',$todos->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('patch')
        ...
        <div class="form-row space-x-4 p-4 font-bold">
        ...
        <div class="form-row mt-3">
          <div class="col-md-3 mb-3">
            <label class="text-green-800 font-bold mr-1">MD/DFO Decision:</label>
            <select class="form-control" name="status" required="required">
              <option value="">-- Select Decision --</option>
              <option value="MD approved">MD approved</option>
              <option value="MD declined">MD declined</option>
              <option value="DFO approved">DFO approved</option>
              <option value="DFO declined">DFO declined</option>
            </select>
          </div>
          <div class="col-md-3 mb-3">
            <label class="text-green-800 font-bold mr-1">MD/DFO Date Review:</label>
            <input type="date" readonly name="mdD" value="{{ date('Y-m-d') }}" class="form-control" required="required">
          </div>
          <div class="col-md-3 mb-3">
            <label class="text-green-800 font-bold mr-1">MD/DFO Name:</label>
            <input type="text" name="mdN" readonly value="{{auth()->user()->name}}" class="form-control">
          </div>
          <div class="col-md-3 mb-3">
