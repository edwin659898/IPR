...
<div class="row">
   ...
   <div class="container" id="printTable">
      <div>
         <form action="{{route('sup.updateMySupplier',$todos->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            @include('layouts.flash')
            <div class="card">
               <div class="card-header">
                  <p class="text-green-800 font-bold text-xl">Update Supplier Information</p>
               ...
               <div class="card-body">
                  ...
                  <div class="form-row px-3 py-2">
                     ...
                     <div class="col">
                        ...
                        <input type="tel" name="tel" class="form-control" value="{{$todos->tel}}" required="required">
                     </div>
                  </div>
                  <div class="form-row px-3 py-2">
                     <div class="col">
                     ...
                     <div class="col">
                        ...
                        <input type="email" name="mail" class="form-control" value="{{$todos->mail}}" required="required">
                     </div>
                     <div class="col">
                  ...
                  <div class="form-row px-3 py-2">
                     ...
                     <div class="col">
                        ...
                        <input type="text" name="swift" class="form-control" value="{{$todos->swift}}">
                     </div>
                     <div class="col">
                  ...
                  <div class="form-row px-3 py-2">
                     <div class="col">
                        ...
                        <input type="tel" name="number" class="form-control" value="{{$todos->number}}">
                     </div>
                     <div class="col">
                  ...
                  <div class="form-row px-3 py-2">
                     ...
                     <div class="col"> 
                        ...
                        <input type="text" name="intro" readonly class="form-control" value="{{$todos->user->name}}">
                     </div>
                     <div class="col">
                        <label class="h8 mb-0  text-green-800">Site</label>
                        <input type="text" readonly name="site" class="form-control" value="{{$todos->user->site}}">
                     </div>
                  </div>
